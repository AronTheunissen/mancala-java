...
public interface Mancala {
    ...
    static final int BOTH_PLAYERS = 3;
     ...
     * @return 15 item long Array with the current state of the game.
     * The 15th item indicates which player has the next turn (possible values are 1 or 2).
     */
